...
func _init() -> void:
	...
	failures += _check("Four of a Kind", [c(9, 0), c(9, 1), c(9, 2), c(9, 3), c(2, 0)])
	...
	failures += _check("Two Pair", [c(3, 0), c(3, 1), c(9, 0), c(9, 1), c(14, 0)])
	failures += _check("Pair", [c(12, 0), c(12, 1)])
	failures += _check("Pair", [c(12, 0), c(12, 1), c(2, 2), c(5, 3), c(9, 0)])
	failures += _check("High Card", [c(14, 0)])
	failures += _check("High Card", [c(2, 0), c(7, 1), c(9, 2), c(12, 3), c(14, 0)])
	# 4 suited cards are NOT a flush; 4 in a row are NOT a straight.
	failures += _check("High Card", [c(2, 2), c(6, 2), c(9, 2), c(11, 2)])
	failures += _check("High Card", [c(5, 0), c(6, 1), c(7, 2), c(8, 3)])
	# Score sanity: pair of queens = 25 base + 24 pips.
	var res := Poker.evaluate([c(12, 0), c(12, 1)])
	if res.score != 49:
		print("FAIL: pair of queens score expected 49, got %d" % res.score)
		failures += 1
