...
| Gold Mine | ~12 of 25 cards are stone blockers; break N stones (3 + region) by chipping (clear cards beside them, 3 chips each) | Shipped. NOT a solid board — the plain cards between stones pop and refill so the mine shifts every hand. Each destroyed stone has a 35% chance to leave a GOLD card in the refill (plays for $1 real cash) |
